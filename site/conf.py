...
copyright = ('2020, Unidata. '
             'Development supported by National Science Foundation grant '
             'AGS-1901712')
...
html_theme_options = {
    'github_url': 'https://github.com/Unidata/pyaos-ams-2021',
    'twitter_url': 'https://twitter.com/Unidata',
...
html_title = 'Unidata AMS 2021 Python Workshop'
...
# of the sidebar.
html_logo = os.path.join('_static', 'Unidata_logo_horizontal.png')
