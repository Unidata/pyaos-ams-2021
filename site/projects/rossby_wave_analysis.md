...
Use GFS analysis products to evaluate real-world applicability of Rossby Wave theory as one would consider in an upper-level undergraduate Dynamics course. Allows application of existing calculations and implementation of own calculations.
...
* [Rossby Waves](https://nbviewer.jupyter.org/github/Unidata/pyaos-ams-2021/blob/master/notebooks/analysis/rossby_waves.ipynb)
